...
const Project = ({ number, title, text, videoSrc }) => {
    return (
        <div className="relative h-auto w-full border-t-2 border-fadedsky-900 dark:border-fadedsky-50 mt-4">
            ...
            <div className="relative flex justify-start flex-col-reverse lg:flex-row w-full h-auto">
                <span className="relative block h-auto flex-3 mr-6 mb-8 overflow-visible">
                    <video
                        className="max-h-128 rounded-lg shadow-lg"
                        src={videoSrc}
                        preload="metadata"
                        controls
                    ></video>
