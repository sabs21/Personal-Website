...
const sunIcon = () => {
    return (
        <svg
            className="text-fadedsky-100 fill-current"
...
const moonIcon = () => {
    return (
        <svg
            className="text-fadedsky-900 fill-current"
            enableBackground="new 0 0 45.16 45.16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
        >
...
const DarkModeToggle = () => {
    ...
    return (
        <button onClick={toggleDarkMode} aria-label="Dark Mode Toggle" className="relative block w-10 h-10 p-2">
