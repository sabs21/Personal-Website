...
const sunIcon = () => {
    return (
        <svg enableBackground="new 0 0 45.16 45.16" version="1.1" viewBox="0 0 45.16 45.16" xmlns="http://www.w3.org/2000/svg">
...
const moonIcon = () => {
    return (
        <svg enable-background="new 0 0 45.16 45.16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
