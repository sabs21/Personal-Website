...
const moonIcon = () => {
    return (
        <svg className="text-gray-100 fill-current" enableBackground="new 0 0 45.16 45.16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
const DarkModeToggle = () => {
    ...
    return (
        <button onClick={toggleDarkMode} className="relative block w-10 h-10 p-2">
