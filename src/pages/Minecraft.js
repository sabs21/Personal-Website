...
import MinecraftBlock from "../components/MinecraftBlock.js"

const Minecraft = () => {
    return (
        <div className="px-8">
            <MinecraftBlock />
            <h1 className="text-5xl text-sky-500 mt-4 mb-2">Witcher's Modpack</h1>
            <p className="relative block text-gray-800 dark:text-gray-200">
