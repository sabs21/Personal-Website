import { Clock, Color } from "../../../three.module.js";
import { DoubleSide } from "../../../src/constants.js";
import { useFrame } from "@react-three/fiber";
import React from "react";

const LanternFlame2 = ({ geometry, renderOrder }) => {
    const innerColor = new Color(0xffd800); // Default is a yellow
    const outerColor = new Color(0xff5200); // Default is an orange
    const shader = LanternFlame2.FlameShader;

    const clock = new Clock();

    // uniforms
    shader.uniforms["time"].value = clock.getDelta();
    shader.uniforms["innerColor"].value = innerColor;
    shader.uniforms["outerColor"].value = outerColor;
