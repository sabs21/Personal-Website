...
class Water3 extends Mesh {
    constructor(geometry, options = {}) {
        ...
        const shader = options.shader || Water3.WaterShader;
        ...
        if (Reflector === undefined) {
            console.error("THREE.Water3: Required component Reflector not found.");
            return;
        }

        if (Refractor === undefined) {
            console.error("THREE.Water3: Required component Refractor not found.");
            return;
        }
